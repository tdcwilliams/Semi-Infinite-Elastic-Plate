...
methods
    function obj = SingleInterfaceCompGal(...
        ...
        obj.params.alpC = .5;%% no submergence.
        if obj.params.INC_SUB & hh(1)~=hh(2)
            obj.params.alpC = 1/6; %% submergence included
        end
    ...
    function obj = assemble(obj)
        ...
        obj.solution.forcing_u = [...
                obj.lhs_info.F(:, 1:obj.lhs_info.num_inc_waves),...
                ZM,...
