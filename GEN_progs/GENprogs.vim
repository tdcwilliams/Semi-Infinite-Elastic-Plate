...
silent only
cd ~/matlab-library/GEN_progs
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 GEN_bestline.m
badd +75 GEN_get_ice_groupvel.m
badd +9 GEN_lin_interp1d.m
badd +12 GEN_lin_interp3d_basis.m
badd +29 GEN_lin_interp3d_locate.m
badd +1 GEN_lin_interp2d_basis.m
badd +26 GEN_lin_interp2d_locate.m
badd +40 GEN_get_ice_wavelength.m
badd +28 GEN_get_wtr_wavelength.m
badd +1 -MiniBufExplorer-
args GEN_lin_interp3d_basis.m GEN_lin_interp3d_locate.m
edit GEN_bestline.m
...
exe '1resize ' . ((&lines * 4 + 16) / 32)
exe '2resize ' . ((&lines * 25 + 16) / 32)
argglobal
enew
